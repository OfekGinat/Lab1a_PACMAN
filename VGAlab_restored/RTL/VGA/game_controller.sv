...
assign collision_smiley_heart = (drawing_request_smiley && HartDrawingRequest);

assign collision = collision_smiley_heart;
...
//	---#7 - change the condition below to collision between Smiley and number ---------
		...
		if ( collision_smiley_heart  && (flag == 1'b0)) begin 
